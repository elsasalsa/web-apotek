...
@section('content')
    ...
    <div class="main">
        ...
        <div class="card" style="display:flex; background-color: white; padding:40px; margin: 10px 50px">
            <div class="d-flex mb-3" style="justify-content:space-between; ">
                <form action="{{ route('admin.student.index') }}" style="" method="GET">
                    ...
                    <a href="{{ route('admin.student.index') }}" class="btn btn-secondary"><ion-icon
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-center">
                                ...
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#edit-student-{{ $item->id }}">
                                    Hapus
                                </button>
                            </td>
                        </tr>
                        <div class="modal" tabindex="-1" id="edit-student-{{ $item->id }}">
